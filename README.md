...
- Latest video on YouTube explaining the Community Detection Algorithm (Leiden): https://youtu.be/hIQM0XLyQiQ?si=9gIhqNZIootXHywc
...
- **Data Visualization:** Power BI, Tableau, Matplotlib, Seaborn, Grafana, Streamlit
- **Database:** SQL Server, MySQL, PostgreSQL, Snowflake
...
- **Architectural Design:** Airflow, Data pipelines for ingestion, cleaning, and transformation
...
- [E-commerce RFM metrics](https://github.com/pedronatanaelfs/data_cleaning)

---

### Data Visualization

- [Microsoft Excel - Sales Dashboard](https://github.com/pedronatanaelfs/excel_projects/tree/main)
- [Microsoft Power BI - Digital Marketing / E-commerce Dashboards](https://github.com/pedronatanaelfs/power_BI_projects/tree/main)
- [Metabase - Multiple Dashboards for sales and education](https://github.com/pedronatanaelfs/metabase_projects)
- [Tableau - British Airways Review](https://github.com/pedronatanaelfs/bitish_airways_review)
- [Grafana - Sales Dashboard with Grafana and PostgreSQL](https://github.com/pedronatanaelfs/sales_analysis_grafana_postgree)

---

### Data Science

- [Classification Model - Obesity level prediction](https://obesityprediction.streamlit.app/)
- [Regression Model - Advertising ROI Prediction](https://github.com/pedronatanaelfs/regression_model)

---

### Generative AI and LLM Integration

- [E-commerce Sales Dashboard with Google LLM Integration](https://github.com/pedronatanaelfs/ecommerce_llm)
...
- **Undergraduate:** Mechanical Engineering - Federal Institute of Pernambuco
...
Available for collaboration and professional inquiries.
